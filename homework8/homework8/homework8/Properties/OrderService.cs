...
namespace OrderSystem
{
    ...
    public class OrderService
    {
        ...
        public OrderService()
       {
        ...
        public void Update(string command, string sign, string infor)
        {
            try 
            { 
                Order temp = Select(command, sign);
                temp.Update(command, infor);
            }
            catch (Exception e)
            {
        ...
        public void Import(string FileLocate)
        {
            try
            {
                BinaryFormatter binaryFormatter = new BinaryFormatter();
                using (FileStream fs = new FileStream("Save.temp", FileMode.Create))
                {
